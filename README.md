...
Select the cloned folder. Eclipse will detect .project and .classpath automatically.
...
git clone https://github.com/eqv1marzz/PangArcadeGame.git
cd PangArcadeGame
Compile all source files inside src/:
bash
javac -d bin src/*.java
-d bin ensures compiled .class files go into the bin/ folder.
Run the game:
bash
java -cp bin Main
...
📂 Levels
Antalya
<img width="854" height="626" alt="image" src="https://github.com/user-attachments/assets/797df45f-2249-49a8-9826-4cc44e5b2b38" />
Ankara
<img width="866" height="631" alt="image" src="https://github.com/user-attachments/assets/839d0582-32e8-4c43-98cd-e19ce46c8ec4" />
İzmir
<img width="861" height="608" alt="image" src="https://github.com/user-attachments/assets/528e5298-7a87-4f12-ba1a-22cd9e13dc91" />
İstanbul
<img width="869" height="608" alt="image" src="https://github.com/user-attachments/assets/c7250b51-f1f2-40f6-90c1-e3906b002625" />
